...
$resultado = mysql_query ("SELECT titulo, archivo FROM personal  WHERE $cedula=cedula", $enlace);
...
if (!$resultado)
{
	...
	exit;
        ...
        echo "";
			 ...
			 $resultado = mysql_query ("UPDATE personal SET titulo='', archivo='' WHERE $cedula=cedula", $enlace);
...
<form method="post" name="form1" id="form1" enctype="multipart/form-data" action="modicar_foto_empleado.php">
         ...
         <p align="center" class="Estilo3"><strong><h3><center>MODIFICAR ARCHIVO</h3></strong></p>
<center>

<br><br>

<table width="772" bgcolor="#FFCCFF">
<tr>
