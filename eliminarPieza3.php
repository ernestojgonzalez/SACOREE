...
<?php
  include "coneccionbasedatosmysql.inc";
	$id_parte_pieza = $_REQUEST['id_parte_pieza'];
   // $cedula = $_POST['cedula'];
	//declarando la variable $registro
	$enlace =conectarbase();
	// $enlace se iguala a la funcion cenectarbase()
 $Eliminar = "DELETE FROM piezas WHERE id_parte_pieza='$id_parte_pieza'; ";
 $resultado=basedatos($Eliminar);
 echo "<center><table><tr><td><BR><p><strong><center>La Pieza fué eliminado</center></strong></p><BR></td></tr></table></center>";
 mysql_close ($enlace);
 ?>
<!-- empieza el formulario    -->
